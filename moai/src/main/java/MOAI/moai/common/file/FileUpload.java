...
public class FileUpload {
    ...
    public static String memberThumbnailUpload(MultipartFile file) {
        return fileUpload(File.separator + "resources" + File.separator + "memberThumbnail", file);
    }

    // music 음악 파일
    public static String musicFileUpload(MultipartFile file) {
        return fileUpload(File.separator + "resources" + File.separator + "musicFile", file);
    }

    // music 음악 썸네일
    public static String musicThumbnailUpload(MultipartFile file) {
        return fileUpload(File.separator + "resources" + File.separator + "musicThumbnail", file);
    }

    // 2차 창작물 영상
    public static String creationFileUpload(MultipartFile file) {
        return fileUpload(File.separator + "resources" + File.separator + "creationFile", file);
    }
